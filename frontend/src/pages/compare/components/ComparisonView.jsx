        ...
        <div ref={card1Ref}>
          ...
          <div className="bg-[rgba(26,38,30,0.8)] rounded-b-xl border border-[rgba(0,255,111,0.15)] overflow-hidden">
            <ResultsDisplay 
              ...
              inputData={{
                country: sim1.input.country,
                policyType: sim1.input.policy_type,
                carbonPrice: sim1.input.carbon_price_usd,
                coverage: sim1.input.coverage_percent,
                year: sim1.input.year,
                duration: sim1.input.projection_years
              }}
            />
          </div>
        </div>
        ...
        <div ref={card2Ref}>
          ...
          <div className="bg-[rgba(26,38,30,0.8)] rounded-b-xl border border-[rgba(0,255,111,0.15)] overflow-hidden">
            <ResultsDisplay 
              ...
              inputData={{
                country: sim2.input.country,
                policyType: sim2.input.policy_type,
                carbonPrice: sim2.input.carbon_price_usd,
                coverage: sim2.input.coverage_percent,
                year: sim2.input.year,
                duration: sim2.input.projection_years
              }}
            />
          </div>
        </div>
